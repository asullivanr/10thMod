	class Module_Tenthed_ODSTDrop: Module_F
	{
			...
			class ODST_Man_1
  			{
				...
				class values
				{
					...
					class n3	{name = "Astra Scout"; value = "OPTRE_UNSC_ODST_Soldier_Scout";};
					class n4	{name = "Astra Scout AT"; value = "OPTRE_UNSC_ODST_Soldier_Scout_AT";}; 
					class n5 	{name = "Astra AR"; value = "OPTRE_UNSC_ODST_Soldier_Rifleman_AR";};
					class n6	{name = "Astra Battle Rifle"; value = "OPTRE_UNSC_ODST_Soldier_Rifleman_BR";}; 
					class n7	{name = "Astra Rifle AT"; value = "OPTRE_UNSC_ODST_Soldier_Rifleman_AT";}; 
					class n8	{name = "Astra LMG"; value = "OPTRE_UNSC_ODST_Soldier_Automatic_Rifleman";}; 
					class n9	{name = "Astra Marksman"; value = "OPTRE_UNSC_ODST_Soldier_Marksman";}; 
					class n10 	{name = "Astra Operative"; value = "OPTRE_UNSC_ONI_Soldier_Operative";};
					class n11   {name = "Astra Scout Sniper"; value = "OPTRE_UNSC_ODST_Soldier_Scout_Sniper";};
					class n12 	{name = "Astra Paramedic"; value = "OPTRE_UNSC_ODST_Soldier_Paramedic";};
					class n13	{name = "Astra Demo Expert"; value = "OPTRE_UNSC_ODST_Soldier_DemolitionsExpert";};
				};
			};	
