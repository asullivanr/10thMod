	...
	hiddenSelectionsTextures[]= { // Change folder to Armor-Misriah\data and put files into that folder. example "Armor-Misriah\data\akira_helmet.paa"
		...
		"Tenthed_Armor_Misriah_Named\data\Den\Thigh_Pouch_Den_co.paa", // Thigh pouch texture
		"Tenthed_Armor_Misriah_Named\data\Den\Reach_Armor_Upper_Den_co.paa", // Upper armor texture and base ODST shoulders.
