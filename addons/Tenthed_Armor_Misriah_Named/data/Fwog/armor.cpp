    ...
    class Tenthed_M56R_Vest_Fwog : Tenthed_Vest_Base {
		...
		hiddenSelectionsTextures[]= { // Change folder to Armor-Misriah\data and put files into that folder. example "Armor-Misriah\data\akira_helmet.paa"
			...
			"Tenthed_Armor_Misriah_Named\data\Fwog\Reach_Armor_Upper_Fwog_co.paa", // Upper armor texture and base ODST shoulders.
			...
			"Tenthed_Armor_Misriah_Named\data\Fwog\Sniper_Fwog_co.paa", // Sniper Shoulders
	...
	class Tenthed_M56SR_Helmet_Fwog : Tenthed_M56SR_Helmet {
		...
		hiddenSelectionsTextures[]= { // un comment out which visor color you would like to test. make sure to comment out the old color or else there will be errors. Blue visor enabled by default.
			"Tenthed_Armor_Misriah_Named\data\Fwog\HR_ODST_Helmet_Fwog_co.paa", // change this texture file to test different helmet textures.
