	class Tenthed_M56R_Vest_Hatchet : Tenthed_Vest_Base {
		...
		hiddenSelectionsTextures[]= { // Change folder to Armor-Misriah\data and put files into that folder. example "Armor-Misriah\data\Hatchet_helmet.paa"
			...
			"Tenthed_Armor_Misriah_Named\data\Hatchet\Reach_Armor_Upper_Hatchet_co.paa", // Upper armor texture and base ODST shoulders.
			"Tenthed_Armor_Misriah_Named\data\Hatchet\Reach_Armor_Lower_Hatchet_co.paa",
			"MA_Armor\data\Vests\Reach_ODST\Canisters_co.paa", // Canisters texture
			"MA_Armor\data\Vests\Reach_ODST\Forearm_Vents_co.paa",
			"Tenthed_Armor_Misriah_Named\data\Hatchet\Sniper_Hatchet_co.paa", // Sniper Shoulders
	...
	class Tenthed_M56SR_Helmet_Hatchet : Tenthed_M56SR_Helmet {
		...
		hiddenSelectionsTextures[]= { // un comment out which visor color you would like to test. make sure to comment out the old color or else there will be errors. Blue visor enabled by default.
			"Tenthed_Armor_Misriah_Named\data\Hatchet\HR_ODST_Helmet_Hatchet_co.paa", // change this texture file to test different helmet textures.
