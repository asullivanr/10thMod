	class Tenthed_M56R_Vest_Seagull : Tenthed_Vest_Base {
		...
		hiddenSelectionsTextures[]= { // Change folder to Armor-Misriah\data and put files into that folder. example "Armor-Misriah\data\Seagull_helmet.paa"
			...
			"Tenthed_Armor_Misriah_Named\data\Seagull\Reach_Armor_Upper_Seagull_co.paa", // Upper armor texture and base ODST shoulders.
			"Tenthed_Armor_Misriah_Named\data\Seagull\Reach_Armor_Lower_Seagull_co.paa",
			...
			"Tenthed_Armor_Misriah_Named\data\Seagull\CQB_Seagull_co.paa", // CQB Shoulders
	...
	class Tenthed_M56SR_Helmet_Seagull : Tenthed_M56SR_Helmet {
		...
		hiddenSelectionsTextures[]= { // un comment out which visor color you would like to test. make sure to comment out the old color or else there will be errors. Blue visor enabled by default.
			"Tenthed_Armor_Misriah_Named\data\Seagull\HR_ODST_Helmet_Seagull_co.paa", // change this texture file to test different helmet textures.
