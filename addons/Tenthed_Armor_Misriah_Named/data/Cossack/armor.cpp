    ...
    class Tenthed_M56R_Vest_Cossack : Tenthed_Vest_Base {
		...
		hiddenSelectionsTextures[]= { // Change folder to Armor-Misriah\data and put files into that folder. example "Armor-Misriah\data\akira_helmet.paa"
			...
			"Tenthed_Armor_Misriah_Named\data\Cossack\Reach_Armor_Upper_Cossack_co.paa", // Upper armor texture and base ODST shoulders.
	...
	class Tenthed_M56SR_Helmet_Cossack : Tenthed_M56SR_Helmet {
		...
		hiddenSelectionsTextures[]= { // un comment out which visor color you would like to test. make sure to comment out the old color or else there will be errors. Blue visor enabled by default.
			"Tenthed_Armor_Misriah_Named\data\Cossack\HR_ODST_Helmet_Cossack_co.paa", // change this texture file to test different helmet textures.
