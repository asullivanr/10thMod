	class Tenthed_M56SR_Helmet_Radical : Tenthed_M56SR_Helmet {
		...
		hiddenSelectionsTextures[]= { // un comment out which visor color you would like to test. make sure to comment out the old color or else there will be errors. Blue visor enabled by default.
			"Tenthed_Armor_Misriah_Named\data\Radical\HR_ODST_Helmet_Radical_co.paa", // change this texture file to test different helmet textures.
	...
	class Tenthed_M56R_Vest_Radical : Tenthed_Vest_Base {
		...
		hiddenSelectionsTextures[]= { // Change folder to Armor-Misriah\data and put files into that folder. example "Armor-Misriah\data\akira_helmet.paa"
			...
			"Tenthed_Armor_Misriah_Named\data\Radical\Reach_Armor_Upper_Radical_co.paa", // Upper armor texture and base ODST shoulders.
			...
			"Tenthed_Armor_Misriah_Named\data\Radical\Sniper_Radical_co.paa", // Sniper Shoulders
			"Tenthed_Armor_Misriah_Named\data\Radical\CQB_Radical_co.paa", // CQB Shoulders
