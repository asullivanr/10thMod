	class Tenthed_M56R_Vest_Clem : Tenthed_Vest_Base {
		...
		hiddenSelectionsTextures[]= { // Change folder to Armor-Misriah\data and put files into that folder. example "Armor-Misriah\data\Clem_helmet.paa"
			...
			"Tenthed_Armor_Misriah_Named\data\Clem\Thigh_Pouch_Clem_co.paa", // Thigh pouch texture
			"Tenthed_Armor_Misriah_Named\data\Clem\Reach_Armor_Upper_Clem_co.paa", // Upper armor texture and base ODST shoulders.
			"Tenthed_Armor_Misriah_Named\data\Clem\Reach_Armor_Lower_Clem_co.paa",
			...
			"Tenthed_Armor_Misriah_Named\data\Clem\CQB_Clem_co.paa", // CQB Shoulders
	...
	class Tenthed_M56SR_Helmet_Clem : Tenthed_M56SR_Helmet {
		...
		hiddenSelectionsTextures[]= { // un comment out which visor color you would like to test. make sure to comment out the old color or else there will be errors. Blue visor enabled by default.
			"Tenthed_Armor_Misriah_Named\data\Clem\HR_ODST_Helmet_Clem_co.paa", // change this texture file to test different helmet textures.
