	class Tenthed_M56SR_Helmet_Failure : Tenthed_M56SR_Helmet {
		scope=2;
		scopeArsenal=2;
		displayName="[10th] M56S-R Helmet (Failure)";
		...
		hiddenSelectionsTextures[]= { // un comment out which visor color you would like to test. make sure to comment out the old color or else there will be errors. Blue visor enabled by default.
			"Tenthed_Armor_Misriah_Named\data\Failure\HR_ODST_Helmet_Failure_co.paa", // change this texture file to test different helmet textures.
	...
	class Tenthed_M56R_Vest_Failure : Tenthed_Vest_Base {
		scope=2;
		scopeArsenal=2;
		displayName="[10th] M56R Armor (Failure)";
		...
		hiddenSelectionsTextures[]= { // Change folder to Armor-Misriah\data and put files into that folder. example "Armor-Misriah\data\akira_helmet.paa"
			...
			"Tenthed_Armor_Misriah_Named\data\Failure\Reach_Armor_Upper_Failure_co.paa", // Upper armor texture and base ODST shoulders.
			...
			"Tenthed_Armor_Misriah_Named\data\Failure\Sniper_Failure_co.paa", // Sniper Shoulders
