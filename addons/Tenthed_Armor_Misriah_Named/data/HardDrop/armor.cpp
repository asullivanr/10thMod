	class Tenthed_M56R_Vest_HardDrop : Tenthed_Vest_Base {
		...
		hiddenSelectionsTextures[]= { // Change folder to Armor-Misriah\data and put files into that folder. example "Armor-Misriah\data\HardDrop_helmet.paa"
			...
			"Tenthed_Armor_Misriah_Named\data\HardDrop\Sniper_HardDrop_co.paa", // Sniper Shoulders
			"Tenthed_Armor_Misriah_Named\data\HardDrop\CQB_HardDrop_co.paa", // CQB Shoulders
