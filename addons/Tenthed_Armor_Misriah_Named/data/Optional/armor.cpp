	class Tenthed_M56A_Helmet_Optional : Tenthed_M56A_Helmet {
		...
		hiddenSelectionsTextures[]= { // un comment out which visor color you would like to test. make sure to comment out the old color or else there will be errors. Blue visor enabled by default.
			"Tenthed_Armor_Misriah_Named\data\Optional\AA_Helmet_Optional_co.paa",
	...
	class Tenthed_M56R_Vest_Optional : Tenthed_Vest_Base {
		...
		hiddenSelectionsTextures[]= { // Change folder to Armor-Misriah\data and put files into that folder. example "Armor-Misriah\data\akira_helmet.paa"
			...
			"Tenthed_Armor_Misriah_Named\data\Optional\Reach_Armor_Upper_Optional_co.paa", // Upper armor texture
			"Tenthed_Armor_Misriah_Named\data\Optional\Reach_Armor_Lower_Optional_co.paa",
