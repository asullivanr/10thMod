	...
	class Tenthed_M56R_Vest_Cookie : Tenthed_Vest_Base {
		scope=2;
		scopeArsenal=2;
		displayName="[10th] M56R Armor (Cookie)";
		...
		hiddenSelectionsTextures[]= { // Change folder to Armor-Misriah\data and put files into that folder. example "Armor-Misriah\data\akira_helmet.paa"
			...
			"Tenthed_Armor_Misriah_Named\data\Cookie\Reach_Armor_Upper_Cookie_co.paa", // Upper armor texture and base ODST shoulders.
			"Tenthed_Armor_Misriah_Named\data\Cookie\Reach_Armor_Lower_Cookie_co.paa",
	...
	class Tenthed_M56SR_Helmet_Cookie : Tenthed_M56SR_Helmet {
		...
		hiddenSelectionsTextures[]= { // un comment out which visor color you would like to test. make sure to comment out the old color or else there will be errors. Blue visor enabled by default.
			"Tenthed_Armor_Misriah_Named\data\Cookie\HR_ODST_Helmet_Cookie_co.paa", // change this texture file to test different helmet textures.
