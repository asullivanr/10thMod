	...
	class Tenthed_M56R_Vest_Beans : Tenthed_Vest_Base {
		...
		hiddenSelectionsTextures[]= { // Change folder to Armor-Misriah\data and put files into that folder. example "Armor-Misriah\data\akira_helmet.paa"
			...
			"Tenthed_Armor_Misriah_Named\data\Beans\Reach_Armor_Upper_Beans_co.paa", // Upper armor texture and base ODST shoulders.
			...
			"Tenthed_Armor_Misriah_Named\data\Beans\CQB_Beans_co.paa", // CQB Shoulders
	...
	class Tenthed_M56SR_Helmet_Beans : Tenthed_M56SR_Helmet {
		...
		hiddenSelectionsTextures[]= { // un comment out which visor color you would like to test. make sure to comment out the old color or else there will be errors. Blue visor enabled by default.
			"Tenthed_Armor_Misriah_Named\data\Beans\HR_ODST_Helmet_Beans_co.paa", // change this texture file to test different helmet textures.
