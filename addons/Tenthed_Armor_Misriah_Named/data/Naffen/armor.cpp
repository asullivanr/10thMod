	class Tenthed_M56E_Helmet_Naffen : Tenthed_M56E_Helmet {
		...
		hiddenSelectionsTextures[]= { // un comment out which visor color you would like to test. make sure to comment out the old color or else there will be errors. Blue visor enabled by default.
			"Tenthed_Armor_Misriah_Named\data\Naffen\EOD_Helmet_Naffen_co.paa",
	...
	class Tenthed_M56R_Vest_Naffen : Tenthed_Vest_Base {
		...
		hiddenSelectionsTextures[]= { // Change folder to Armor-Misriah\data and put files into that folder. example "Armor-Misriah\data\akira_helmet.paa"
			...
			"Tenthed_Armor_Misriah_Named\data\Naffen\Thigh_Pouch_Naffen_co.paa",
			"Tenthed_Armor_Misriah_Named\data\Naffen\Reach_Armor_Upper_Naffen_co.paa", // Upper armor texture
			...
			"Tenthed_Armor_Misriah_Named\data\Naffen\CQB_Naffen_co.paa", // CQB Shoulders
