	class Tenthed_M56R_Vest_Dex : Tenthed_Vest_Base {
		scope=2;
		scopeArsenal=2;
		displayName="[10th] M56R Armor (Dex)";
		...
		hiddenSelectionsTextures[]= { // Change folder to Armor-Misriah\data and put files into that folder. example "Armor-Misriah\data\Leek_helmet.paa"
			...
			"Tenthed_Armor_Misriah_Named\data\Dex\Reach_Armor_Upper_Dex_co.paa", // Upper armor texture and base ODST shoulders.
			"Tenthed_Armor_Misriah_Named\data\Dex\Reach_Armor_Lower_Dex_co.paa",
	...
	class Tenthed_M56E_Helmet_Dex : Tenthed_M56E_Helmet {
		...
		hiddenSelectionsTextures[]= { // un comment out which visor color you would like to test. make sure to comment out the old color or else there will be errors. Blue visor enabled by default.
			"Tenthed_Armor_Misriah_Named\data\Dex\EOD_Helmet_Dex_co.paa", // change this texture file to test different helmet textures.
