	class Tenthed_M56R_Vest_Drake : Tenthed_Vest_Base {
		scope=2;
		scopeArsenal=2;
		displayName="[10th] M56R Armor (Drake)";
		model="MA_Armor\data\Vests\H3_ODST\H3_ODST_Armor.p3d";
		picture="MA_Armor\data\Icons\H3ODST_Vest.paa";
		hiddenSelectionsTextures[]= { // Change folder to Armor-Misriah\data and put files into that folder. example "Armor-Misriah\data\Drake_helmet.paa"
			...
			"z\10thMod\addons\armor_misriah_named\data\Drake\Reach_Armor_Upper_Drake_co.paa", // Upper armor texture and base ODST shoulders.
			"z\10thMod\addons\armor_misriah_named\data\Drake\Reach_Armor_Lower_Drake_co.paa",
			...
			"z\10thMod\addons\armor_misriah_named\data\Drake\CQB_Drake_co.paa", // CQB Shoulders
	...
	class Tenthed_M56SR_Helmet_Drake : Tenthed_M56SR_Helmet {
		scope=2;
		scopeArsenal=2;
		displayName="[10th] M56S-R Helmet (Drake)";
		...
		hiddenSelectionsTextures[]= { // un comment out which visor color you would like to test. make sure to comment out the old color or else there will be errors. Blue visor enabled by default.
			"z\10thMod\addons\armor_misriah_named\data\Drake\HR_ODST_Helmet_Drake_co.paa", // change this texture file to test different helmet textures.
