	...
	class Tenthed_M56R_Vest_Metro : Tenthed_Vest_Base {
		scope=2;
		scopeArsenal=2;
		displayName="[10th] M56R Armor (Metro)";
		...
		hiddenSelectionsTextures[]= { // Change folder to Armor-Misriah\data and put files into that folder. example "Armor-Misriah\data\akira_helmet.paa"
			...
			"z\10thMod\addons\armor_misriah_named\data\Metro\Reach_Armor_Upper_Metro_co.paa", // Upper armor texture and base ODST shoulders.
	...
	class Tenthed_M56SR_Helmet_Metro : Tenthed_M56SR_Helmet {
		scope=2;
		scopeArsenal=2;
		displayName="[10th] M56S-R Helmet (Metro)";
		...
		hiddenSelectionsTextures[]= { // un comment out which visor color you would like to test. make sure to comment out the old color or else there will be errors. Blue visor enabled by default.
			"z\10thMod\addons\armor_misriah_named\data\Metro\HR_ODST_Helmet_Metro_co.paa", // change this texture file to test different helmet textures.
