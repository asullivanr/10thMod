	class Tenthed_M56SR_Helmet_Cheeto : Tenthed_M56SR_Helmet {
		...
		hiddenSelectionsTextures[]= { // un comment out which visor color you would like to test. make sure to comment out the old color or else there will be errors. Blue visor enabled by default.
			"z\10thMod\addons\armor_misriah_named\data\Cheeto\HR_ODST_Helmet_Cheeto_co.paa", // change this texture file to test different helmet textures.
	...
	class Tenthed_M56R_Vest_Cheeto : Tenthed_Vest_Base {
		...
		hiddenSelectionsTextures[]= { // Change folder to Armor-Misriah\data and put files into that folder. example "Armor-Misriah\data\akira_helmet.paa"
			...
			"z\10thMod\addons\armor_misriah_named\data\Cheeto\Reach_Armor_Upper_Cheeto_co.paa", // Upper armor texture and base ODST shoulders.
			"z\10thMod\addons\armor_misriah_named\data\Cheeto\Reach_Armor_Lower_Cheeto_co.paa",
			...
			"z\10thMod\addons\armor_misriah_named\data\Cheeto\CQB_Cheeto_co.paa", // CQB Shoulders
