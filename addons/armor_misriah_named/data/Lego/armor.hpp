	class Tenthed_M56A_Helmet_Lego : Tenthed_M56A_Helmet {
		scope=2;
		scopeArsenal=2;
		displayName="[10th] M56-A Helmet (Lego)";
		...
		hiddenSelectionsTextures[]= { // un comment out which visor color you would like to test. make sure to comment out the old color or else there will be errors. Blue visor enabled by default.
			"z\10thMod\addons\armor_misriah_named\data\Lego\AA_Helmet_Lego_co.paa",
	...
	class Tenthed_M56R_Vest_Lego : Tenthed_Vest_Base {
		scope=2;
		scopeArsenal=2;
		displayName="[10th] M56R Armor (Lego)";
		...
		hiddenSelectionsTextures[]= { // Change folder to Armor-Misriah\data and put files into that folder. example "Armor-Misriah\data\akira_helmet.paa"
			...
			"z\10thMod\addons\armor_misriah_named\data\Lego\Thigh_Pouch_Lego_co.paa",
			"z\10thMod\addons\armor_misriah_named\data\Lego\Reach_Armor_Upper_Lego_co.paa", // Upper armor texture
			"z\10thMod\addons\armor_misriah_named\data\Lego\Reach_Armor_Lower_Lego_co.paa",
