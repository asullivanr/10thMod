	class Tenthed_M56SR_Helmet_Splash : Tenthed_M56SR_Helmet {
		scope=2;
		scopeArsenal=2;
		displayName="[10th] M56S-R Helmet (Splash)";
		...
		hiddenSelectionsTextures[]= { // un comment out which visor color you would like to test. make sure to comment out the old color or else there will be errors. Blue visor enabled by default.
			"z\10thMod\addons\armor_misriah_named\data\Splash\HR_ODST_Helmet_Splash_co.paa", // change this texture file to test different helmet textures.
	...
	class Tenthed_M56R_Vest_Splash : Tenthed_Vest_Base {
		scope=2;
		scopeArsenal=2;
		displayName="[10th] M56R Armor (Splash)";
		...
		hiddenSelectionsTextures[]= { // Change folder to Armor-Misriah\data and put files into that folder. example "Armor-Misriah\data\akira_helmet.paa"
			...
			"z\10thMod\addons\armor_misriah_named\data\Splash\Thigh_Pouch_Splash_co.paa", // Thigh pouch texture
			"z\10thMod\addons\armor_misriah_named\data\Splash\Reach_Armor_Upper_Splash_co.paa", // Upper armor texture and base ODST shoulders.
			"z\10thMod\addons\armor_misriah_named\data\Splash\Reach_Armor_Lower_Splash_co.paa",
			"MA_Armor\data\Vests\Reach_ODST\Canisters_co.paa", // Canisters texture
			"MA_Armor\data\Vests\Reach_ODST\Forearm_Vents_co.paa",
			"z\10thMod\addons\armor_misriah_named\data\Splash\Sniper_Splash_co.paa", // Sniper Shoulders
