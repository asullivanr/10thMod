	class Tenthed_M56R_Vest_Gutts : Tenthed_Vest_Base {
		scope=2;
		scopeArsenal=2;
		displayName="[10th] M56R Armor (Gutts)";
		model="MA_Armor\data\Vests\H3_ODST\H3_ODST_Armor.p3d";
		picture="MA_Armor\data\Icons\H3ODST_Vest.paa";
		hiddenSelectionsTextures[]= { // Change folder to Armor-Misriah\data and put files into that folder. example "Armor-Misriah\data\Gutts_helmet.paa"
			...
			"z\10thMod\addons\armor_misriah_named\data\Gutts\Reach_Armor_Upper_Gutts_co.paa", // Upper armor texture and base ODST shoulders.
			"z\10thMod\addons\armor_misriah_named\data\Gutts\Reach_Armor_Lower_Gutts_co.paa",
			...
			"z\10thMod\addons\armor_misriah_named\data\Gutts\CQB_Gutts_co.paa", // CQB Shoulders
	...
	class Tenthed_M56E_Helmet_Gutts : Tenthed_M56E_Helmet {
		scope=2;
		scopeArsenal=2;
		displayName="[10th] M56-E Helmet (Gutts)";
		...
		hiddenSelectionsTextures[]= { // un comment out which visor color you would like to test. make sure to comment out the old color or else there will be errors. Blue visor enabled by default.
			"z\10thMod\addons\armor_misriah_named\data\Gutts\EOD_Helmet_Gutts_co.paa", // change this texture file to test different helmet textures.
