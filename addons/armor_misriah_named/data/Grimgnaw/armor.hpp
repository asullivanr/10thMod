	...
	class Tenthed_M56R_Vest_Grimgnaw : Tenthed_Vest_Base {
	scope=2;
	scopeArsenal=2;
	displayName="[10th] M56R Armor (Grimgnaw)";
	...
	hiddenSelectionsTextures[]= { // Change folder to Armor-Misriah\data and put files into that folder. example "Armor-Misriah\data\akira_helmet.paa"
		...
		"z\10thMod\addons\armor_misriah_named\data\Grimgnaw\Reach_Armor_Upper_Grimgnaw_co.paa", // Upper armor texture and base ODST shoulders.
		...
		"z\10thMod\addons\armor_misriah_named\data\Grimgnaw\Sniper_Grimgnaw_co.paa", // Sniper Shoulders
	...
	class Tenthed_M56_Scout_Helmet_Grimgnaw : Tenthed_M56_Scout_Helmet {
		scope=2;
		scopeArsenal=2;
		displayName="[10th] M65-S Helmet (Grimgnaw)";
		...
		hiddenSelectionsTextures[]= { // un comment out which visor color you would like to test. make sure to comment out the old color or else there will be errors. Blue visor enabled by default.
			"z\10thMod\addons\armor_misriah_named\data\Grimgnaw\Scout_Helmet_Grimgnaw_co.paa",
