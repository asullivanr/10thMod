	...
	class Tenthed_M56A_Helmet_Akira : Tenthed_M56SR_Helmet {
		...
		hiddenSelectionsTextures[]= {
			"z\10thMod\addons\armor_misriah_named\data\Akira\HR_ODST_Helmet_Akira_CO.paa",
	...
	class Tenthed_M56R_Vest_Akira : Tenthed_Vest_Powered {
		scope=2;
		scopeArsenal=2;
		...
		hiddenSelectionsTextures[]= { // Change folder to Armor-Misriah\data and put files into that folder. example "z\10thMod\addons\armor_misriah_named\data\Akira\akira_helmet.paa"
			...
			"z\10thMod\addons\armor_misriah_named\data\Akira\H3_Upper_Armor_Akira_co.paa", // Upper armor texture
			"z\10thMod\addons\armor_misriah_named\data\Akira\H3_Lower_Armor_Akira_co.paa",
