	...
	class Tenthed_M56R_Vest_Hodge : Tenthed_Vest_Base {
		scope=2;
		scopeArsenal=2;
		displayName="[10th] M56R Armor (Hodge)";
		...
		hiddenSelectionsTextures[]= { // Change folder to Armor-Misriah\data and put files into that folder. example "Armor-Misriah\data\akira_helmet.paa"
			...
			"z\10thMod\addons\armor_misriah_named\data\Hodge\Reach_Armor_Upper_Hodge_co.paa", // Upper armor texture and base ODST shoulders.
			...
			"z\10thMod\addons\armor_misriah_named\data\Hodge\CQB_Hodge_co.paa", // CQB Shoulders
	...
	class Tenthed_M56SR_Helmet_Hodge : Tenthed_M56SR_Helmet {
		...
		hiddenSelectionsTextures[]= { // un comment out which visor color you would like to test. make sure to comment out the old color or else there will be errors. Blue visor enabled by default.
			"z\10thMod\addons\armor_misriah_named\data\Hodge\HR_ODST_Helmet_Hodge_co.paa", // change this texture file to test different helmet textures.
