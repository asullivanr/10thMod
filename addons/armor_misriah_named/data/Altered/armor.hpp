	class Tenthed_M56SR_Helmet_Altered : Tenthed_M56SR_Helmet {
		scope=2;
		scopeArsenal=2;
		displayName="[10th] M56S-R Helmet (Altered)";
		...
		hiddenSelectionsTextures[]= { // un comment out which visor color you would like to test. make sure to comment out the old color or else there will be errors. Blue visor enabled by default.
			"z\10thMod\addons\armor_misriah_named\data\Altered\HR_ODST_Helmet_Altered_co.paa", // change this texture file to test different helmet textures.
	...
	class Tenthed_M56R_Vest_Altered : Tenthed_Vest_Base {
		scope=2;
		scopeArsenal=2;
		displayName="[10th] M56R Armor (Altered)";
		...
		hiddenSelectionsTextures[]= { // Change folder to Armor-Misriah\data and put files into that folder. example "Armor-Misriah\data\akira_helmet.paa"
			...
			"z\10thMod\addons\armor_misriah_named\data\Altered\Reach_Armor_Upper_Altered_co.paa", // Upper armor texture and base ODST shoulders.
			"z\10thMod\addons\armor_misriah_named\data\Altered\Reach_Armor_Lower_Altered_co.paa",
			...
			"z\10thMod\addons\armor_misriah_named\data\Altered\CQB_Altered_co.paa", // CQB Shoulders
