	class Tenthed_M56E_Helmet_Menace : Tenthed_M56E_Helmet {
		scope=2;
		scopeArsenal=2;
		displayName="[10th] M56-E Helmet (Menace)";
		...
		hiddenSelectionsTextures[]= { // un comment out which visor color you would like to test. make sure to comment out the old color or else there will be errors. Blue visor enabled by default.
			"z\10thMod\addons\armor_misriah_named\data\Menace\EOD_Helmet_Menace_co.paa", // change this texture file to test different helmet textures.
	...
	class Tenthed_M56R_Vest_Menace : Tenthed_Vest_Base {
		scope=2;
		scopeArsenal=2;
		displayName="[10th] M56R Armor (Menace)";
		...
		hiddenSelectionsTextures[]= { // Change folder to Armor-Misriah\data and put files into that folder. example "Armor-Misriah\data\akira_helmet.paa"
			...
			"z\10thMod\addons\armor_misriah_named\data\Menace\Thigh_Pouch_Menace_co.paa", // Thigh pouch texture
			"z\10thMod\addons\armor_misriah_named\data\Menace\Reach_Armor_Upper_Menace_co.paa", // Upper armor texture and base ODST shoulders.
			...
			"z\10thMod\addons\armor_misriah_named\data\Menace\Sniper_Menace_co.paa", // Sniper Shoulders
