	class Tenthed_M56E_Helmet_Naffen : Tenthed_M56E_Helmet {
		scope=2;
		scopeArsenal=2;
		displayName="[10th] M56-E Helmet (Naffen)";
		...
		hiddenSelectionsTextures[]= { // un comment out which visor color you would like to test. make sure to comment out the old color or else there will be errors. Blue visor enabled by default.
			"z\10thMod\addons\armor_misriah_named\data\Naffen\EOD_Helmet_Naffen_co.paa",
	...
	class Tenthed_M56R_Vest_Naffen : Tenthed_Vest_Base {
		scope=2;
		scopeArsenal=2;
		displayName="[10th] M56R Armor (Naffen)";
		...
		hiddenSelectionsTextures[]= { // Change folder to Armor-Misriah\data and put files into that folder. example "Armor-Misriah\data\akira_helmet.paa"
			...
			"z\10thMod\addons\armor_misriah_named\data\Naffen\Thigh_Pouch_Naffen_co.paa",
			"z\10thMod\addons\armor_misriah_named\data\Naffen\Reach_Armor_Upper_Naffen_co.paa", // Upper armor texture
			...
			"z\10thMod\addons\armor_misriah_named\data\Naffen\CQB_Naffen_co.paa", // CQB Shoulders
