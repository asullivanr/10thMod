	class Tenthed_M56SR_Helmet_Chugs : Tenthed_M56SR_Helmet {
		scope=2;
		scopeArsenal=2;
		displayName="[10th] M56S-R Helmet (Chugs)";
		...
		hiddenSelectionsTextures[]= { // un comment out which visor color you would like to test. make sure to comment out the old color or else there will be errors. Blue visor enabled by default.
			"z\10thMod\addons\armor_misriah_named\data\Chugs\HR_ODST_Helmet_Chugs_co.paa", // change this texture file to test different helmet textures.
	...
	class Tenthed_M56R_Vest_Chugs : Tenthed_Vest_Base {
		scope=2;
		scopeArsenal=2;
		displayName="[10th] M56R Armor (Chugs)";
		...
		hiddenSelectionsTextures[]= { // Change folder to Armor-Misriah\data and put files into that folder. example "Armor-Misriah\data\akira_helmet.paa"
			...
			"z\10thMod\addons\armor_misriah_named\data\Chugs\Reach_Armor_Upper_Chugs_co.paa", // Upper armor texture and base ODST shoulders.
			...
			"z\10thMod\addons\armor_misriah_named\data\Chugs\Sniper_Chugs_co.paa", // Sniper Shoulders
