	class Tenthed_M56SR_Helmet_Velo : Tenthed_M56SR_Helmet {
		scope=2;
		scopeArsenal=2;
		displayName="[10th] M56S-R Helmet (Velo)";
		...
		hiddenSelectionsTextures[]= { // un comment out which visor color you would like to test. make sure to comment out the old color or else there will be errors. Blue visor enabled by default.
			"z\10thMod\addons\armor_misriah_named\data\Velo\HR_ODST_Helmet_Velo_co.paa", // change this texture file to test different helmet textures.
	...
	class Tenthed_M56R_Vest_Velo : Tenthed_Vest_Base {
		scope=2;
		scopeArsenal=2;
		displayName="[10th] M56R Armor (Velo)";
		...
		hiddenSelectionsTextures[]= { // Change folder to Armor-Misriah\data and put files into that folder. example "Armor-Misriah\data\akira_helmet.paa"
			...
			"z\10thMod\addons\armor_misriah_named\data\Velo\Thigh_Pouch_Velo_co.paa", // Thigh pouch texture
			"z\10thMod\addons\armor_misriah_named\data\Velo\Reach_Armor_Upper_Velo_co.paa", // Upper armor texture and base ODST shoulders.
			...
			"z\10thMod\addons\armor_misriah_named\data\Velo\Sniper_Velo_co.paa", // Sniper Shoulders
			"z\10thMod\addons\armor_misriah_named\data\Velo\CQB_Velo_co.paa", // CQB Shoulders
