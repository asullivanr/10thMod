	...
	class Tenthed_M56R_Vest_Evader : Tenthed_Vest_Base {
		...
		hiddenSelectionsTextures[]= { // Change folder to Armor-Misriah\data and put files into that folder. example "Armor-Misriah\data\akira_helmet.paa"
			...
			"z\10thMod\addons\armor_misriah_named\data\Evader\Reach_Armor_Upper_Evader_co.paa", // Upper armor texture and base ODST shoulders.
			"z\10thMod\addons\armor_misriah_named\data\Evader\Reach_Armor_Lower_Evader_co.paa",
			...
			"z\10thMod\addons\armor_misriah_named\data\Evader\CQB_Evader_co.paa", // CQB Shoulders
	...
	class Tenthed_M56E_Helmet_Evader : Tenthed_M56E_Helmet {
		scope=2;
		scopeArsenal=2;
		displayName="[10th] M56-E Helmet (Evader)";
		...
		hiddenSelectionsTextures[]= { // un comment out which visor color you would like to test. make sure to comment out the old color or else there will be errors. Blue visor enabled by default.
			"z\10thMod\addons\armor_misriah_named\data\Evader\EOD_Helmet_Evader_co.paa",
