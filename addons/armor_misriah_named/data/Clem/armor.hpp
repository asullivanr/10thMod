	class Tenthed_M56R_Vest_Clem : Tenthed_Vest_Base {
		scope=2;
		scopeArsenal=2;
		displayName="[10th] M56R Armor (Clem)";
		model="MA_Armor\data\Vests\H3_ODST\H3_ODST_Armor.p3d";
		picture="MA_Armor\data\Icons\H3ODST_Vest.paa";
		hiddenSelectionsTextures[]= { // Change folder to Armor-Misriah\data and put files into that folder. example "Armor-Misriah\data\Clem_helmet.paa"
			// No other texture files then the ones with comments will be altered.
			"MA_Armor\data\Vests\H3_ODST\H3_Upper_Armor_co.paa",
			"MA_Armor\data\Vests\H3_ODST\H3_Lower_Armor_co.paa",
			"z\10thMod\addons\armor_misriah_named\data\Clem\Thigh_Pouch_Clem_co.paa", // Thigh pouch texture
			"z\10thMod\addons\armor_misriah_named\data\Clem\Reach_Armor_Upper_Clem_co.paa", // Upper armor texture and base ODST shoulders.
			"z\10thMod\addons\armor_misriah_named\data\Clem\Reach_Armor_Lower_Clem_co.paa",
			...
			"z\10thMod\addons\armor_misriah_named\data\Clem\CQB_Clem_co.paa", // CQB Shoulders
	...
	class Tenthed_M56SR_Helmet_Clem : Tenthed_M56SR_Helmet {
		scope=2;
		scopeArsenal=2;
		displayName="[10th] M56S-R Helmet (Clem)";
		...
		hiddenSelectionsTextures[]= { // un comment out which visor color you would like to test. make sure to comment out the old color or else there will be errors. Blue visor enabled by default.
			"z\10thMod\addons\armor_misriah_named\data\Clem\HR_ODST_Helmet_Clem_co.paa", // change this texture file to test different helmet textures.
