	...
	class Tenthed_M56R_Vest_Infra : Tenthed_Vest_Base {
		...
		hiddenSelectionsTextures[]= { // Change folder to Armor-Misriah\data and put files into that folder. example "Armor-Misriah\data\akira_helmet.paa"
			...
			"z\10thMod\addons\armor_misriah_named\data\Infra\Thigh_Pouch_Infra_co.paa", // Thigh pouch texture
			"z\10thMod\addons\armor_misriah_named\data\Infra\Reach_Armor_Upper_Infra_co.paa", // Upper armor texture and base ODST shoulders.
			"z\10thMod\addons\armor_misriah_named\data\Infra\Reach_Armor_Lower_Infra_co.paa",
			...
			"z\10thMod\addons\armor_misriah_named\data\Infra\CQB_Infra_co.paa", // CQB Shoulders
	...
	class Tenthed_M56SR_Helmet_Infra : Tenthed_M56SR_Helmet {
		...
		hiddenSelectionsTextures[]= { // un comment out which visor color you would like to test. make sure to comment out the old color or else there will be errors. Blue visor enabled by default.
			"z\10thMod\addons\armor_misriah_named\data\Infra\HR_ODST_Helmet_Infra_co.paa", // change this texture file to test different helmet textures.
