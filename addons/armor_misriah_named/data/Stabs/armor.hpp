	class Tenthed_M56SR_Helmet_Stabs : Tenthed_M56SR_Helmet {
		scope=2;
		scopeArsenal=2;
		displayName="[10th] M56S-R Helmet (Stabs)";
		...
		hiddenSelectionsTextures[]= { // un comment out which visor color you would like to test. make sure to comment out the old color or else there will be errors. Blue visor enabled by default.
			"z\10thMod\addons\armor_misriah_named\data\Stabs\HR_ODST_Helmet_Stabs_co.paa", // change this texture file to test different helmet textures.
	...
	class Tenthed_M56R_Vest_Stabs : Tenthed_Vest_Base {
		scope=2;
		scopeArsenal=2;
		displayName="[10th] M56R Armor (Stabs)";
		...
		hiddenSelectionsTextures[]= { // Change folder to Armor-Misriah\data and put files into that folder. example "Armor-Misriah\data\akira_helmet.paa"
			...
			"z\10thMod\addons\armor_misriah_named\data\Stabs\Thigh_Pouch_Stabs_co.paa", // Thigh pouch texture
			"z\10thMod\addons\armor_misriah_named\data\Stabs\Reach_Armor_Upper_Stabs_co.paa", // Upper armor texture and base ODST shoulders.
