	class Tenthed_M56SR_Helmet_Woo : Tenthed_M56SR_Helmet {
		scope=2;
		scopeArsenal=2;
		displayName="[10th] M56S-R Helmet (Woo)";
	...
	class Tenthed_M56R_Vest_Woo : Tenthed_Vest_Base {
		scope=2;
		scopeArsenal=2;
		displayName="[10th] M56R Armor (Woo)";
