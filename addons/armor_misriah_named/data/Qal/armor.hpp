	class Tenthed_M56E_Helmet_Qal : Tenthed_M56E_Helmet {
		scope=2;
		scopeArsenal=2;
		displayName="[10th] M56-E Helmet (Qal)";
		...
		hiddenSelectionsTextures[]= { // un comment out which visor color you would like to test. make sure to comment out the old color or else there will be errors. Blue visor enabled by default.
			"z\10thMod\addons\armor_misriah_named\data\Qal\EOD_Helmet_Qal_co.paa", // change this texture file to test different helmet textures.
	...
	class Tenthed_M56R_Vest_Qal : Tenthed_Vest_Base {
		scope=2;
		scopeArsenal=2;
		displayName="[10th] M56R Armor (Qal)";
		...
		hiddenSelectionsTextures[]= { // Change folder to Armor-Misriah\data and put files into that folder. example "Armor-Misriah\data\akira_helmet.paa"
			...
			"z\10thMod\addons\armor_misriah_named\data\Qal\Thigh_Pouch_Qal_co.paa", // Thigh pouch texture
			"z\10thMod\addons\armor_misriah_named\data\Qal\Reach_Armor_Upper_Qal_co.paa", // Upper armor texture and base ODST shoulders.
			"z\10thMod\addons\armor_misriah_named\data\Qal\Reach_Armor_Lower_Qal_co.paa",
