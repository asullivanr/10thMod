	class Tenthed_M56A_Helmet_Optional : Tenthed_M56A_Helmet {
		scope=2;
		scopeArsenal=2;
		displayName="[10th] M56-A Helmet (Optional)";
		...
		hiddenSelectionsTextures[]= { // un comment out which visor color you would like to test. make sure to comment out the old color or else there will be errors. Blue visor enabled by default.
			"z\10thMod\addons\armor_misriah_named\data\Optional\AA_Helmet_Optional_co.paa",
	...
	class Tenthed_M56R_Vest_Optional : Tenthed_Vest_Powered {
		scope=2;
		scopeArsenal=2;
		displayName="[10th] M56R Armor (Optional)";
		...
		hiddenSelectionsTextures[]= { // Change folder to Armor-Misriah\data and put files into that folder. example "Armor-Misriah\data\akira_helmet.paa"
			...
			"z\10thMod\addons\armor_misriah_named\data\Optional\Reach_Armor_Upper_Optional_co.paa", // Upper armor texture
			"z\10thMod\addons\armor_misriah_named\data\Optional\Reach_Armor_Lower_Optional_co.paa",
