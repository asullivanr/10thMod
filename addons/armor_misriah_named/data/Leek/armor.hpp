	class Tenthed_M56R_Vest_Leek : Tenthed_Vest_Base {
		scope=2;
		scopeArsenal=2;
		displayName="[10th] M56R Armor (Leek)";
		...
		hiddenSelectionsTextures[]= { // Change folder to Armor-Misriah\data and put files into that folder. example "Armor-Misriah\data\Leek_helmet.paa"
			...
			"z\10thMod\addons\armor_misriah_named\data\Leek\Reach_Armor_Upper_Leek_co.paa", // Upper armor texture and base ODST shoulders.
			"z\10thMod\addons\armor_misriah_named\data\Leek\Reach_Armor_Lower_Leek_co.paa",
	...
	class Tenthed_M56E_Helmet_Leek : Tenthed_M56E_Helmet {
		scope=2;
		scopeArsenal=2;
		displayName="[10th] M56-E Helmet (Leek)";
		...
		hiddenSelectionsTextures[]= { // un comment out which visor color you would like to test. make sure to comment out the old color or else there will be errors. Blue visor enabled by default.
			"z\10thMod\addons\armor_misriah_named\data\Leek\EOD_Helmet_Leek_co.paa", // change this texture file to test different helmet textures.
