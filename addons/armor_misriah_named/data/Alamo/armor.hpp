	class Tenthed_M56SR_Helmet_Alamo : Tenthed_M56SR_Helmet {
		scope=2;
		scopeArsenal=2;
		displayName="[10th] M56S-R Helmet (Alamo)";
		...
		hiddenSelectionsTextures[]= { // un comment out which visor color you would like to test. make sure to comment out the old color or else there will be errors. Blue visor enabled by default.
			"z\10thMod\addons\armor_misriah_named\data\Alamo\HR_ODST_Helmet_Alamo_co.paa", // change this texture file to test different helmet textures.
	...
	class Tenthed_M56R_Vest_Alamo : Tenthed_Vest_Base {
		scope=2;
		scopeArsenal=2;
		displayName="[10th] M56R Armor (Alamo)";
		...
		hiddenSelectionsTextures[]= { // Change folder to Armor-Misriah\data and put files into that folder. example "Armor-Misriah\data\akira_helmet.paa"
			...
			"z\10thMod\addons\armor_misriah_named\data\Alamo\Thigh_Pouch_Alamo_co.paa", // Thigh pouch texture
			"z\10thMod\addons\armor_misriah_named\data\Alamo\Reach_Armor_Upper_Alamo_co.paa", // Upper armor texture and base ODST shoulders.
			"z\10thMod\addons\armor_misriah_named\data\Alamo\Reach_Armor_Lower_Alamo_co.paa",
			"MA_Armor\data\Vests\Reach_ODST\Canisters_co.paa", // Canisters texture
			"MA_Armor\data\Vests\Reach_ODST\Forearm_Vents_co.paa",
			"z\10thMod\addons\armor_misriah_named\data\Alamo\Sniper_Alamo_co.paa", // Sniper Shoulders
