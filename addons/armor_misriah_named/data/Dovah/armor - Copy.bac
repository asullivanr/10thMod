	class Tenthed_M56R_Vest_Dovah : Tenthed_Vest_Base {
		...
		hiddenSelectionsTextures[]= { // Change folder to Armor-Misriah\data and put files into that folder. example "Armor-Misriah\data\Dovah_helmet.paa"
			...
			"z\10thMod\addons\armor_misriah_named\data\Dovah\Reach_Armor_Upper_Dovah_co.paa", // Upper armor texture and base ODST shoulders.
			"z\10thMod\addons\armor_misriah_named\data\Dovah\Reach_Armor_Lower_Dovah_co.paa",
			"MA_Armor\data\Vests\Reach_ODST\Canisters_co.paa", // Canisters texture
			"MA_Armor\data\Vests\Reach_ODST\Forearm_Vents_co.paa",
			"z\10thMod\addons\armor_misriah_named\data\Dovah\Sniper_Dovah_co.paa", // Sniper Shoulders
	...
	class Tenthed_M56SR_Helmet_Dovah : Tenthed_M56SR_Helmet {
		scope=2;
		scopeArsenal=2;
		displayName="[10th] M56S-R Helmet (Dovah)";
		...
		hiddenSelectionsTextures[]= { // un comment out which visor color you would like to test. make sure to comment out the old color or else there will be errors. Blue visor enabled by default.
			"z\10thMod\addons\armor_misriah_named\data\Dovah\HR_ODST_Helmet_Dovah_co.paa", // change this texture file to test different helmet textures.
