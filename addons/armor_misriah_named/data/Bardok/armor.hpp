	class Tenthed_M56R_Vest_Bardok : Tenthed_Vest_Base {
		scope=2;
		scopeArsenal=2;
		displayName="[10th] M56R Armor (Bardok)";
		...
		hiddenSelectionsTextures[]= { // Change folder to Armor-Misriah\data and put files into that folder. example "Armor-Misriah\data\akira_helmet.paa"
			...
			"z\10thMod\addons\armor_misriah_named\data\Bardok\Thigh_Pouch_Bardok_co.paa", // Thigh pouch texture
			"z\10thMod\addons\armor_misriah_named\data\Bardok\Reach_Armor_Upper_Bardok_co.paa", // Upper armor texture and base ODST shoulders.
			...
			"z\10thMod\addons\armor_misriah_named\data\Bardok\Sniper_Bardok_co.paa", // Sniper Shoulders
	...
	class Tenthed_M56E_Helmet_Bardok : Tenthed_M56E_Helmet {
		scope=2;
		scopeArsenal=2;
		displayName="[10th] M56-E Helmet (Bardok)";
		...
		hiddenSelectionsTextures[]= { // un comment out which visor color you would like to test. make sure to comment out the old color or else there will be errors. Blue visor enabled by default.
			"z\10thMod\addons\armor_misriah_named\data\Bardok\EOD_Helmet_Bardok_co.paa",
